            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <h1 style={{marginTop: '2px', textAlign: 'center'}}>
                                <div style={{borderTop: '2px solid black', borderBottom: '2px solid black', display: 'inline-block'}}>
                                    {category.category}
                                </div>
                            </h1>
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button
                                            className={cart.some((item) => item.name === plant.name) 
